...
function setSecondsTimeoutArgs(cb, delayInSeconds, ...args) {
  // Your code here
  //The remaining arguments in the setTimeout are going to be arguments for the callback
  // used the rest-spread syntax to pass all additional argument to the 
...
//Problem encountered , didn't install the dependencies for the test files.
